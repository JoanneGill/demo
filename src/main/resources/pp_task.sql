...
CREATE TABLE `pp_task_claim`  (
  ...
  `sec_uid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `card_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diamond` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1515 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for pp_task_claim_history
-- ----------------------------
DROP TABLE IF EXISTS `pp_task_claim_history`;
CREATE TABLE `pp_task_claim_history`  (
  ...
  `card_no` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `diamond` int NULL DEFAULT NULL,
  INDEX `idx_claim_history_room_device_time`(`room_id` ASC, `device_id` ASC, `begin_time` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for pp_task_history
-- ----------------------------
DROP TABLE IF EXISTS `pp_task_history`;
